...
RUN sed -i -- '/<interface name="public">/{n;s/<inet-address value="127.0.0.1"\/>/<any-ipv4-address\/>/}' $JBOSS_HOME/standalone/configuration/standalone.xml
...
CMD ["/opt/jboss/as7/bin/standalone.sh"]
